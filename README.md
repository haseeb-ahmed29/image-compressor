...
A client-side image optimization tool for reducing image file size before sharing or publishing.

## Purpose

This repository was created as a practical project to explore the design and implementation of **Image Compressor**. It can be used as a learning reference, a starting point for further development, or a demonstration of the related business workflow.
...
3. Choose an image, select the available compression settings, preview the result, and download the optimized file.
